"""
Django settings for elite_42349 project.
...
WSGI_APPLICATION = 'elite_42349.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "elite_42349 API",
    "DESCRIPTION": "API documentation for elite_42349 App",
    "VERSION": "v1",
}
